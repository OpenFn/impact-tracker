...
#
#     PHX_SERVER=true bin/impact_tracker start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :impact_tracker, ImpactTrackerWeb.Endpoint, server: true
end

config :impact_tracker, Oban,
  queues: [default: 4],
...
if config_env() == :prod do
  ...
  config :impact_tracker, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :impact_tracker, ImpactTracker.Mailer,
